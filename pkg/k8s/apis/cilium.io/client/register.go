...
const (
	...
	CGCCCRDName = k8sconstv2alpha1.CGCCPKindDefinition + "/" + k8sconstv2alpha1.CustomResourceDefinitionVersion
)
...
func CustomResourceDefinitionList() map[string]*CRDList {
	return map[string]*CRDList{
		...
		synced.CRDResourceName(k8sconstv2alpha1.CGCCPName): {
			Name:     CGCCCRDName,
			FullName: k8sconstv2alpha1.CGCCPName,
		},
	}
}
